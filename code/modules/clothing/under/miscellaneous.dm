...
/obj/item/clothing/under/suit_jacket/redsuit
	name = "traje rojo"
	desc = "Un elegante traje con una camisa roja y pantalones."
	icon_state = "redsuit"
	item_state = "redsuit"
	worn_state = "redsuit"


/obj/item/clothing/under/suit_jacket/redsuit/redsuitskirt
	name = "traje rojo con falda"
	desc = "Un elegante traje con una camisa roja y una falda."
	icon_state = "redsuitskirt"
	item_state = "redsuitskirt"
	worn_state = "redsuitskirt"
